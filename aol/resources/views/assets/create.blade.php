        ...
        <div class="bg-white p-8 rounded-lg shadow-md w-full max-w-md">
            ...
            <form action="{{ route('products.store') }}" method="post" enctype="multipart/form-data">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="Title" id="Title" placeholder="Enter the report title"
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="Description" id="Description" placeholder="Enter report description"
                        class="mt-1 p-3 w-full border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-indigo-500">
                </div>
